class InstagramContent extends ContentClass {
  constructor({
    Comport,
    CurrrentUser,
    LastUsername,
  ...
  getUserData(a) {
    $.get("https://www.instagram.com/" + a + "/?__a=1", function (n, d) {
      this.SendMessage("userData", "User", n.graphql.user);
    });
  }
  ...
  OnMessageReceive(a) {
    if ("FollowUser" == a.Tag) FollowUser(a.User);
      ...
      for (
        ...
        n[d].innerText &&
          ...
          this.SendMessage("BadTarget", "Media", "");
      ...
      d.includes("It looks like you shared your password") &&
        (this.SendMessage(
          "blocked",
          "blocked",
          "compromised" + window.location.href
        ),
        setTimeout(function () {
                ...
                for (
                  ...
                  if (
                    ...
                    z &&
                      ...
                      this.SendMessage("addStory", "story", {
                        username: z,
                        user_id: 0,
                        full_name: "",
    ...
    else if ("RetriveUserHeaders" == a.Tag) this.RetriveUserHeaders();
    else if ("Timer" == a.Tag)
      $("#timer").html(a.Time.toFixed(0) + " seconds till next action");
    else if ("CollectStoriesFromTag" == a.Tag)
      collectStoriesFromTag(a.variables);
    else if ("CollectStoriesFromAccount" == a.Tag)
      collectStoriesFromAccount(a.variables);
    else if ("DoCollectJob" == a.Tag) this.DoCollectJob(a.Job);
    else if ("DODM" == a.Tag)
      (startDM = !0),
                            ...
                            for (b = 0; b < c.length; b++)
                              if (
                                ...
                                c[b]
                                  .getAttribute("alt")
                                  .includes(
                                    a.story.username.split("/").join("")
                                  )
                              ) {
                                this.SendMessage("CommentedMedia", "Media", {
                                  caption: x,
    ...
    else if ("GetUserData" == a.Tag) this.getUserData(a.username);
    else if ("validateInstagramFollowers" == a.Tag)
      this.RetriveCurrentUserInfoManual(1);
                              ...
                              setTimeout(function () {
                                ...
                                for (p = 0; p < l.length; p++)
                                  "undefined" != typeof l[p] &&
                                    ...
                                    l[p].firstElementChild.getAttribute(
                                      "alt"
                                    ) &&
                              ...
                              setTimeout(function () {
                                ...
                                for (K = 0; K < J.length; K++)
                                  "undefined" != typeof J[K] &&
                                    ...
                                    J[K].firstElementChild.getAttribute(
                                      "alt"
                                    ) &&
                                    ...
                                    this.SendMessage("addStory", "story", w));
                              }, M);
                            }, M);
                          }, M);
                        }, M);
      ...
      30 > Math.floor(100 * Math.random()) &&
        this.SendMessage("ErrorStory", "Error", "No BUttons");
              ...
              m[x] &&
                ...
                H < a.story.minFollowing &&
                  ...
                  (A =
                    ...
                    H)));
        commented = !1;
        this.SendMessage("SkipFollowStory", "text", ca + "  " + A);
        var I = "temp";
                ...
                for (var c = 0; c < b.length; c++)
                  if (
                    ...
                    if (
                      ...
                      break;
                    this.SendMessage("FollowedUserStory", "User", {
                      followed_time: 0,
                      full_name: "",
                      user_id: "0",
                      user_pic_url: "assets/images/icon.png",
            ...
            setTimeout(function () {
              for (
                ...
                if (
                  ...
                  if (1e3 < D && 1e5 > D) {
                    this.SendMessage("IdealTarget", "target", {
                      username: ha,
                      followers: D,
                    });
                    break;
                          ...
                          if (a.story.getStats)
                            for (
                              ...
                              if (
                                ...
                                "undefined" !=
                                  typeof r[u].parentNode.parentNode
                                    .children[2] &&
                                "undefined" !=
                                  typeof r[u].parentNode.parentNode
                                    .children[0] &&
                                ...
                                a.story.getStats &&
                                  this.SendMessage("gotStats", "followers", {
                                ...
                                if (a.story.StartComment && 8 <= ka) {
                                  ...
                                  1 == a.story.backgroundDMs
                                    ? -1 == a.story.recents.indexOf(f[0]) &&
                                      ...
                                      (t.push(f[0]),
                                      (msg_user = f[0]),
                                      this.SendMessage("Recents", "recents", t),
                                      this.SendMessage(
                                        "DODM",
                                        "username",
                                        f[0]
              ...
              setTimeout(function () {
                ...
                for (var t = 0; t < q.length; t++)
                  if (
                    ...
                    this.SendMessage("LikedMedia", "Media", t);
                    k = !0;
                    setTimeout(function () {
                      for (
      ...
      setTimeout(function () {
        ...
        a.story.getStats &&
          (z =
            "Gathering user follower stats first. <br>Starting automation on next story.");
        $("#inject").html(z);
        this.SendMessage("SkipFollowStory", "text", z);
        30 > Math.floor(100 * Math.random()) &&
          this.SendMessage("ErrorStory", "Error", "No BUttons");
        ...
        if (
          ...
          (m = window.location.href.split("/")[4]),
            this.SendMessage("GetFollowLike", "User", {
              dofollow: x,
              dolike: H,
              dounfollow: N,
              dodm: P,
                        ...
                        setTimeout(function () {
                          ...
                          for (var y = 0; y < g.length; y++)
                            if (
                              ...
                              this.SendMessage("LikedMedia", "Media", y);
                              setTimeout(function () {
                                for (
                                  var J =
                                      document.getElementsByTagName("button"),
      ...
      "DoGetJob" == a.Tag
        ...
        ? this.DoCollectMediaFromTag(a.MediaTag)
        ...
        ? ((d = new User(
          ...
          this.SendMessage("AddUserToWhitelistContent", "user", d))
        : "DoCollectMediaFromLocation" == a.Tag
        ? this.DoCollectMediaFromLocation(a.MediaTag)
        : "DoCollectMediaFromAccount" != a.Tag &&
          ("DoLikeMedia" == a.Tag
            ? this.DoLikeMedia(a.Media)
            : "DoCommentMedia" == a.Tag && this.DoCommentMedia(a.Media));
  }

  OnReceiveCollectJobStatus(a) {
    $("#instabaiter-inject");
  ...
  OnClickCollectFollowers() {
    var a = $(UserTag).text();
    this.GetCurrentPageUserData(a, function (n) {
      ...
      "false" == $(d).attr("insta")
        ? ((d = {}),
          ...
          (d.cursor_key = null),
          (d.user = n),
          this.SendMessage("AddCollectJob", "Job", d))
        : this.SendMessage("RemoveCollectJob", "user_id", n.user_id);
      this.SendMessage("RequestCollectJobStatus", "user_id", n.user_id);
    });
  }
  ...
  DoCollectMediaFromTag(a) {
    this.CollectMediaFromTag(a, function (n) {
      0 < n.length && this.SendMessage("AddMedia", "Medias", n);
    });
  }
  DoCollectMediaFromLocation(a) {
    this.CollectMediaFromLocation(a, function (n) {
      0 < n.length && this.SendMessage("AddMedia", "Medias", n);
    });
  }
  DoCollectMediaFromAccount(a) {}
  DoGetJob(a) {
    this.CollectUsersFromOnce(a, function (n) {
      0 < n.length && SendMessage("GotFollowers", "Users", n);
    });
  }

  DoCollectJob(a) {
    this.CollectUsersFrom(a, function (n) {
  ...
  DoCollectFollowings(a) {
    this.CollectFollowings(a.user_id, a.cursor_key, function (n) {
      n && 0 < n.length && this.SendMessage("AddFollowings", "Users", n);
    });
  }

  GetCurrentPageUserData(a, n) {
    n(null);
  }
  ...
  RetriveCurrentUserInfoManual(a) {
    var n = "";
    a = document.getElementsByTagName("a");
    ...
    for (
      ...
      (!a[M].getAttribute("href") ||
        ...
        ("undefined" !=
          ...
          (d = !0)),
        a[M].parentNode.parentNode.parentNode.children[0].children[2]
          .children[0].children[4].children[1].children[0] &&
          "undefined" !=
            typeof a[M].parentNode.parentNode.parentNode.children[0].children[2]
              .children[0].children[4].children[1].children[0] &&
...
var usern;
var commented;
var instagramContent = new InstagramContent({
  Comport: Comport,
...
$(document).ready(function () {
  ...
  0 == instagramContent.story_set &&
    window.location.href.includes("stories") &&
    instagramContent.SendMessage("GetStory", "Error", "No BUttons");
  0 == instagramContent.startDM &&
    window.location.href.includes("direct") &&
    instagramContent.SendMessage("GetDM", "Error", "No BUttons");
});
